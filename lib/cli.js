...
function cmdInit() {
  ...
  Next steps:
    ...
    4. Start building with the /n8n-creator Claude Code skill
  `);
}

function cmdAudit(args) {
  header('n8n-creator — TDD Audit');
  const tddBin = require.resolve('@lhi/tdd-audit/bin/tdd-audit') ||
                 path.join(PKG_DIR, 'node_modules', '.bin', 'tdd-audit');
